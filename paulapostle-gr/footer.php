			...
			<?php
				...
				$html .= '
					<li class="footer-contact">
						...
						<a href="tel:' . get_option( 'opt_page_footer_contact_text_34' ) . '"><img class="social-icon" src="/wp-content/themes/dpi-theme-v4/icons/smartphone.svg" alt="Phone" /><strong>' . get_option( 'opt_page_footer_contact_text_34' ) . '</strong></a>
						<a href="mailto:' . get_option( 'opt_page_footer_contact_text_35' ) . '"><img class="social-icon" src="/wp-content/themes/dpi-theme-v4/icons/email.svg" alt="email" /><strong>' . get_option( 'opt_page_footer_contact_text_35' ) . '</strong></a>
