...
class DPI_Slider_Nav_Meta {
  ...
  public function nav_menu_cb() {
    wp_enqueue_script( 'dpi-slider-nav-meta-js', get_template_directory_uri() . '/scripts/js/slider-nav-meta.es5.js', ['jquery'], true );
    ?>
...
$dpi_slider_nav_meta = new DPI_Slider_Nav_Meta();
